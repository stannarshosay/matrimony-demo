...
class Common_model extends CI_Model {
	...
	// for relation, Join tabel
		...
		$this->photo_upload_count = 8; // not more then 8
...

	{
...

		{
...

			{
				...
				log_message("info",$query_generated);
...

	{
...

		{
...

			{
				...
				$row_data = $this->get_count_data_manual($relation_arr['rel_table']," is_deleted='No' ",2,$select_field,$relation_arr['key_disp'].' ASC ');
				// print_r($row_data);
...

	{
...

		{
			...
			$photo_number = $this->get_value($element_array_val,'photo_number');
            ...
            $path_photos_big  = 'assets/photos_big/';
...

			{
				...
				//	$img_display = '<img style="'.$inline_style.'" id="img-responsive" class="img-responsive" src="'.$this->base_url.$path_value.$value_curr.'" />';
				//sonu change
					$img_display = ' <a  href="'.$this->base_url.$path_photos_big.$value_curr.'" title="<?php echo $images; ?>" data-lightbox="'.$path_value.$value_curr.'"><img style="height:222px;width:190px;object-fit: cover;" id="img-responsive" class="img-responsive" src="'.$this->base_url.$path_value.$value_curr.'" /></a>';
					//sonu chaange end

				}else{

					$img_display = '<a  href="'.$this->base_url.$path_photos_big.$value_curr.'" title="<?php echo $images; ?>" data-lightbox="'.$path_value.$value_curr.'"><img style="max-height:100%" id="img-responsive" class="img-responsive" src="'.$this->base_url.$path_value.$value_curr.'" /></a>';
			...
			//if(isset($photo_number) && $photo_number != '' && $key == 'photo1'){
				...
				<div class="form-group '.$form_group_class.''.$key.'">
                  ...
                  <div class=col-sm-4>
                     ...
                     <div class="pull-left float-none" data-toggle="modal" data-target="#myModal_pic" onClick="set_photo_number('.$photo_number.')">
                    ...
                    <div class=col-sm-4>
                     ...
                     <div class="pull-left float-none" id="photo_delete_btn_<?php echo '.$photo_number.'; ?>" data-toggle="modal" data-target="#myModal_delete" onClick="set_photo_number('.$photo_number.')" onLoad="my_photo()">
                          <label class="add-w-btn new-id-s-photo btn-file  Poppins-Regular f-14 color-f">
                                     <i class="fa fa-upload"></i> Delete 
                                        </label>
...

	{
...

		{
...

			{
				...
				$sendNotificationStatus = $this->message_model->send_notification("Your payment of ".$plan_data["plan_amount"]." for plan ".$plan_data["plan_name"]." has been recieved","Admin",$matri_id);
				...
				if(isset($admin_payment) && $admin_payment == 'admin_payment'){
					...
					//in app notifications
					$sendNotificationStatus = $this->message_model->send_notification("Your paid membership for plan ".$plan_data["plan_name"]." has been activated","Admin",$matri_id);
...

	{
		...
		$marital_status= array('Unmarried'=>'Unmarried','Widow/Widower'=>'Widow/Widower','Divorcee'=>'Divorcee','Separated'=>'Separated','Awaiting Divorce'=>'Awaiting Divorce');
...
=>'166cm','167cm'=>'167cm','168cm'=>'168cm','169cm'=>'169cm','170cm'=>'170cm','171cm'=>'171cm','172cm'=>'172cm','173cm'=>'173cm','174cm'=>'174cm','175cm'=>'175cm','176cm'=>'176cm','177cm'=>'177cm','178cm'=>'178cm','179cm'=>'179cm','180cm'=>'180cm','181cm'=>'181cm','182cm'=>'182cm','183cm'=>'183cm','184cm'=>'184cm','185cm'=>'185cm','186cm'=>'186cm','187cm'=>'187cm','188cm'=>'188cm','189cm'=>'189cm','190cm'=>'190cm','191cm'=>'191cm','192cm'=>'192cm','193cm'=>'193cm','194cm'=>'194cm','195cm'=>'195cm','196cm'=>'196cm','197cm'=>'197cm','198cm'=>'198cm','199cm'=>'199cm','200cm'=>'200cm','201cm'=>'201cm','202cm'=>'202cm','203cm'=>'203cm','204cm'=>'204cm','205cm'=>'205cm','206cm'=>'206cm','207cm'=>'207cm','208cm'=>'208cm','209cm'=>'209cm','210cm'=>'210cm','211cm'=>'211cm','212cm'=>'212cm','213cm'=>'213cm');
		...
		$profileby = array('Self'=>'Self','Parents'=>'Parents','Guardian'=>'Guardian','Friends'=>'Friends','Sibling'=>'Sibling','Relatives'=>'Relatives','Admin' => 'Admin');

		//$reference = array('Advertisements'=>'Advertisements','Friends'=>'Friends','Search Engines'=>'Search Engines','Others'=>'Others');

		$reference = array('Tele-in'=>'Tele-in','Telemarketing'=>'Telemarketing','Event/Activity'=>'Event/Activity','TV Advertisment'=>'TV Advertisment','Newspaper Advertisment'=>'Newspaper Advertisment','Theater Advertisment'=>'Theater Advertisment','Magazine Advertisment'=>'Magazine Advertisment','Hoarding'=>'Hoarding','Notice/Pamphelt'=>'Notice/Pamphelt','Radio'=>'Radio','Google Search'=>'Google Search','Social Media'=>'Social Media','Referral'=>'Referral','Branding'=>'Branding','Others'=>'Others');
		...
		$employee_in = array('Private'=>'Private','Govt'=>'Govt','Central Govt'=>'Central Govt','MNC'=>'MNC','Overseas'=>'Overseas','Own Business'=>'Own Business','Others'=>'Others','Public Limited'=>'Public Limited','Semi Govt'=>'Semi Govt');
		
		$work_category = array('Private'=>'Private','Govt'=>'Govt','Central Govt'=>'Central Govt','MNC'=>'MNC','Overseas'=>'Overseas','Own Business'=>'Own Business','Others'=>'Others','Public Limited'=>'Public Limited','Semi Govt'=>'Semi Govt');
		...
		$family_type = array('Separate Family'=>'Separate Family','Joint Family'=>'Joint Family','Nuclear Family'=>'Nuclear Family');

		$income = array('0 - 1 Lakh'=>'0 - 1 Lakh','1 - 2 Lakhs'=>'1 - 2 Lakhs','2 - 3 Lakhs'=>'2 - 3 Lakhs','3 - 4 Lakhs'=>'3 - 4 Lakhs','4 - 5 Lakhs'=>'4 - 5 Lakhs','5 - 6 Lakhs'=>'5 - 6 Lakhs','6 - 7 Lakhs'=>'6 - 7 Lakhs','7 - 8 Lakhs'=>'7 - 8 Lakhs','8 - 9 Lakhs'=>'8 - 9 Lakhs','9 - 10 Lakhs'=>'9 - 10 Lakhs','10 - 12 Lakhs'=>'10 - 12 Lakhs','12 - 14 Lakhs'=>'12 - 14 Lakhs','14 - 16 Lakhs'=>'14 - 16 Lakhs','16 - 18 Lakhs'=>'16 - 18 Lakhs','18 - 20 Lakhs'=>'18 - 20 Lakhs','20 - 25 Lakhs'=>'20 - 25 Lakhs','25 - 30 Lakhs'=>'25 - 30 Lakhs','30 - 35 Lakhs'=>'30 - 35 Lakhs','35 - 40 Lakhs'=>'35 - 40 Lakhs','40 - 45 Lakhs'=>'40 - 45 Lakhs','45 - 50 Lakhs'=>'45 - 50 Lakhs','50 - 55 Lakhs'=>'50 - 55 Lakhs','55 - 60 Lakhs'=>'55 - 60 Lakhs','60 - 65 Lakhs'=>'60 - 65 Lakhs','65 - 70 Lakhs'=>'65 - 70 Lakhs','70 - 75 Lakhs'=>'70 - 75 Lakhs','75 - 80 Lakhs'=>'75 - 80 Lakhs','80 - 58 Lakhs'=>'80 - 85 Lakhs','85 - 90 Lakhs'=>'85 - 90 Lakhs','90 Lakhs - 1 Crore'=>'90 Lakhs - 1 Crore','1 Crore & Above'=>'1 Crore & Above');

		$parent_status = array('Employed'=>'Employed','Business'=>'Business','Professional'=>'Professional','Agriculture/Farming'=>'Agriculture/Farming','Retired'=>'Retired','Not Employed'=>'Not Employed','Passed Away'=>'Passed Away');

		$father_status = array('Employed'=>'Employed','Business'=>'Business','Professional'=>'Professional','Agriculture/Farming'=>'Agriculture/Farming','Retired'=>'Retired','Not Employed'=>'Not Employed','Passed Away'=>'Passed Away');

		$mother_status = array('House Wife'=>'House Wife','Employed'=>'Employed','Business'=>'Business','Professional'=>'Professional','Agriculture/Farming'=>'Agriculture/Farming','Retired'=>'Retired','Not Employed'=>'Not Employed','Passed Away'=>'Passed Away');

		$family_status = array('Rich Class'=>'Rich Class','Upper Middle Class'=>'Upper Middle Class','Middle Class'=>'Middle Class','Lower Middle Class'=>'Lower Middle Class','Poor Family'=>'Poor Family');
		...
		$id_proof_name = array('Aadhar card'=>'Aadhar card','Driving Licence'=>'Driving Licence','Voters ID'=>'Voters ID','Passport'=>'Passport');
        ...
        $mode_of_payemnt = array('Cash'=>'Cash','Cheque'=>'Cheque','UPI'=>'UPI','Net Banking'=>'Net Banking');
        
        $package_plan = array('10000'=>'10000','15000'=>'15000','25000'=>'25000','50000'=>'50000','1 lakh'=>'1 lakh');
        
        $commission = array('5%'=>'5%','10%'=>'10%','15%'=>'15%','20%'=>'20%');
