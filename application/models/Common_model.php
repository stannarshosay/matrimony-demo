...

		{
...

			{
...

				{
					...
					{
						log_message("info",$relation_arr['rel_col_val'].">>".$relation_arr['rel_col_name']);
...

		{
...

			{
				...
				if(isset($inline_style) && $inline_style != ''){
					...
					$img_display = '<img style="max-height:100px" id="img-responsive" class="img-responsive" src="'.$this->base_url.$path_value.$value_curr.'" />';
