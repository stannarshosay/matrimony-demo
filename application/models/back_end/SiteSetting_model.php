...
/*	public function generate_form_google_analytics_setting($success_url='')
	...
	function update_color( )
	{
		...
		{			
			...
			$temp = file_get_contents("assets/front_end_new/css/mega-scss.css");
			$rgba_color = 'rgba('.$rgba_color.',0.82)';
			$temp_arr = array("#ni_text_color#"=>$font_color,"#ni_bg_color#"=>$colour_name,"#ni_bg_color_rgb#"=>$rgba_color);
			
			$final_css = strtr($temp,$temp_arr);
			file_put_contents("assets/front_end_new/css/mega.css",$final_css);
		}
