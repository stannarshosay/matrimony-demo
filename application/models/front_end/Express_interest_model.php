...

		{
...

			{
				...
				if(($status=="accept")||($status=="reject")){
					...
					$sendNotificationStatus = $this->message_model->send_notification("Your interest request has been ".$status."ed by ".$receiver,$receiver,$sender);
				}
				if(isset($reminder_mail) && $reminder_mail=='yes'){
					...
					//in app notifications
					$sendNotificationStatus = $this->message_model->send_notification("You have been reminded of the interest expressed by ".$sender,$sender,$receiver);
