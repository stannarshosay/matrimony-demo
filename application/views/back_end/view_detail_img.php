 <?php $defult_not_upload_src = 'assets/images/no_image.png';
 
 $path_folder1 = 'assets/photos_big/';
            ...
            <div class="row">
...

                {
                    ...
                    { 
...

						{
							...
							$file_name_imges = $path_folder1.$file_name_img;
                ...
                <div class="<?php echo $class_width; ?> text-center mb20">
...

					{
					    ...
					    if ($filed_arr_img_val == 'photo1'){
				
            				echo '<span class="text-bold">Profile Pic &nbsp;&nbsp;&nbsp;<br/></span>';
				...
				<!--sonu change-->
                    ...
                    <a  href="<?php echo $base_url.$file_name_imges; ?>" title="<?php echo $images; ?>" data-lightbox="<?php echo $file_name_img;; ?>"><img <?php echo $inline_style; ?> src="<?php echo $base_url.$file_name_img; ?>" class="magniflier <?php echo $img_class; ?>" alt="<?php echo $file_name_img;?>" /></a>
                <!--sonu change end-->
                    <!--<img <?php echo $inline_style; ?> src="<?php echo $base_url.$file_name_img; ?>" class="magniflier <?php echo $img_class; ?>" alt="<?php echo $file_name_img;?>" />-->
