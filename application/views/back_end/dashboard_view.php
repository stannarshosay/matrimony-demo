      ...
      <div class="widget bg-white">
        ...
        <div class="widget-details widget-list">
          ...
          <div class="">
            ...
            <h4 class="no-margin text-uppercase">Religion Vice Mem
...
$member_data = $this->common_model->get_count_data_manual('register_view',$where_mem_ber_perm,2,',id,matri_id,username,email,gender,last_login,religion_name,country_name,city_name,caste_name,registered_on,mobile,plan_status',' registered_on desc ',1,12);
        ...
        <div class="widget-details widget-list">
         ...
         <div>
           ...
           <table class="table">
             ...
             <tbody>
...

              {
               ...
               <tr>
                 ...
                 <!--<td><a href="<?php echo $base_url.'control-panel/member/member_list/edit-data/'?><?php echo $member_data_val['id'] ?>"><?php if(isset($member_data_val['matri_id']) && $member_data_val['matri_id'] !=''){echo $member_data_val['matri_id'];}else{ echo $na;} ?></a></td>-->
                 <td><a href="<?php echo $base_url.'control-panel/member/member_detail/'?><?php echo $member_data_val['id'] ?>"><?php if(isset($member_data_val['matri_id']) && $member_data_val['matri_id'] !=''){echo $member_data_val['matri_id'];}else{ echo $na;} ?></a></td>
                 <td><?php if(isset($member_data_val['username']) && $member_data_val['username'] !=''){echo strtoupper($member_data_val['username']);}else{ echo $na;} ?></td>

                 

              <td><?php if(isset($member_data_val['gender']) && $member_data_val['gender'] !=''){echo $member_data_val['gender'];}else{ echo $na;} ?></td>

              <td><?php if(isset($member_data_val['mobile']) && $member_data_val['mobile'] !=''){echo $member_data_val['mobile'];}else{ echo $na;} ?></td>
             ...
             <td><?php if(isset($member_data_val['religion_name']) && $member_data_val['religion_name'] !=''){echo $member_data_val['religion_name'];}else{ echo $na;} ?></td>
             
            

             <td><?php if(isset($member_data_val['last_login']) && $member_data_val['last_login'] !=''){echo $member_data_val['last_login'];}else{ echo $na;} ?></td>

             <td><?php echo $this->common_model->displayDate($member_data_val['registered_on']); ?></td>
             <td><?php if(isset($member_data_val['plan_status']) && $member_data_val['plan_status'] !=''){echo $member_data_val['plan_status'];}else{ echo $na;} ?></td>
