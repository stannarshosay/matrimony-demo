...
$member_data = $this->common_model->get_count_data_manual('register_view',$where_mem_ber_perm,2,',id,matri_id,username,email,gender,last_login,religion_name,country_name,city_name,caste_name,registered_on',' registered_on desc ',1,12);
