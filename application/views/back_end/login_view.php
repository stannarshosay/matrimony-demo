          ...
          <div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
            <form id="login_form" method="post" role="form" action="<?php echo $base_url.$admin_path.'/'.$user_url.'/check_login';?>" class="form-layout" ><!--onSubmit="return check_validation()"-->
             ...
             <div class=form-inputs>
                ...
                <input required type="password" name="password" id="password" class="form-control input-lg" placeholder="Password" value="<?php if(isset($password_place) && $password_place !='') { echo $password_place; } ?>" />
