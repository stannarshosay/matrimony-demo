                ...
                <div class="col-md-12">
                    ...
                    <div class="tab mega-admin-tab" role="tabpanel">
                        ...
                        <div class="tab-content tabs mega-panel">
                           ...
                           // print_r($this->common_model->data_tabel_data);
...

                            {
                                ...
                                <h3 class="col-lg-<?php echo $i;?> col-xs-10 col-md-5"><?php 
                                    ...
                                    if(isset($data_table_mem['post_title_disp']) && isset($data_val[$data_table_mem['post_title_disp']]) && $data_val[$data_table_mem['post_title_disp']] !=''){
                                       ...
                                       echo $personal_title = '<small style="word-wrap:break-word; color:#ff0000;">  '.$data_val[$data_table_mem['post_title_disp']].' </small>';
                                    ...
                                    //print_r($this->common_model->status_field);
                                    ...
                                    if($status_val=='APPROVED' && isset($data_val['plan_status']) && $data_val['plan_status'] !='' && $data_val['plan_status'] =='Paid' || ($status_val=='Featured' || $status_val=='Unfeatured')){
                                        ...
                                        $thumb_val = 'fa fa-star text-danger';

                                        $thumb_val_color = 'text-danger';
                                        ...
                                        <div class="row">
                                           <?php // sonu backend
                                            for($i=2;$i<=$this->photo_upload_count;$i++){
                                                $temp_images = $data_val['photo'.$i];
                                               
                                                //print_r( $temp_images);
                                               if(file_exists($path_img.$temp_images)){
                                                if(isset($temp_images)){
                                                   
                                                $images = $path_img.$temp_images;
                                                $images1 = $path_img1.$temp_images;
                                                ?>
...

                                    {
                                        ...
                                        {?>
                                            ...
                                            <div class="col-lg-6 col-xs-12 neAdminResultDetail">
                                                ...
                                                <?php
                                						$color='#333';
                                						 if($data_val[$disp_column_array_val] == ''|| $data_val[$disp_column_array_val] == '0000-00-00' ){
                                						    $color = '#ff0000';
                                                ...
                                                <div class="col-lg-8 col-xs-8" style="word-wrap:break-word; color:<?php echo $color;?>">:&nbsp;
...
.row:after {
  ...
  clear: both;
        ...
        <!--sonu change style for popup zoom image-->
