...
<div class="box-tab justified" id="rootwizard">
    ...
    // basic detail
        ...
        //'diocese'=>array('type'=>'dropdown','class'=>'select2','value_arr'=>$this->common_model->get_list_ddr('diocese')),
				...
				'employee_in'=>array('type'=>'dropdown','class'=>'select2','value_arr'=>$this->common_model->get_list_ddr('employee_in'),'label'=>'Employee(Work) Category'),
				...
				//'work_category'=>array('type'=>'dropdown','class'=>'select2','value_arr'=>$this->common_model->get_list_ddr('work_category'),'label'=>'Work Category'),
...

{
	...
	$ele_array = array(
		...
		'profileby'=>array('is_required'=>'required','type'=>'dropdown','class'=>'select2','value_arr'=>$this->common_model->get_list_ddr('profileby'),'label'=>'Profile Created By','onchange'=>"profilebychange()"),
...

{
	...
	$ele_array = array(
		...
		'part_employee_in'=>array('is_multiple'=>'yes','display_placeholder'=>'No','class'=>'select2','type'=>'dropdown','value_arr'=>$this->common_model->get_list_ddr('employee_in'),'label'=>'Partner Employed(Work) Category'),
    ...
    <div class="modal-dialog  modal-dialog-vendor">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header new-header-modal" style="border-bottom: 1px solid #e5e5e5;">
                ...
                <p class="Poppins-Bold mega-n3 new-event text-center">Delete This Saved <span class="mega-n4 f-s"> Picture</span></p>
            ...
            <div class="modal-body">
				...
				<div id="delete_photo_alt" class="alert alert-danger" style="overflow:hidden;">
                    ...
                    <div class="col-md-10 col-sm-6 col-xs-12">
                        ...
                        <strong>Are you sure you want to Remove  Picture?</strong><br />

                        <span class="small">This  Picture will be Deleted Permanently from your saved  Pictures.</span>
