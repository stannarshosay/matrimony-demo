...

{
    ...
    $('html, body').animate({
        ...
        scrollTop: $('#' + div_id).offset().top - 55
    }, 'slow');
...
function profilebychange()

{

    var profile_by = $("[name='profileby']").val();

    if (profile_by == 'Self' || profile_by == 'Admin') {

        $('.prfcreatorname').css('display', 'none');

        $('.prfcreatorno').css('display', 'none');

    } else {
        $('.prfcreatorname').css('display', 'block');

        $('.prfcreatorno').css('display', 'block');
    }
