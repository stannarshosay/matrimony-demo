...
function update_photo() {
    ...
    var url_load = base_url + 'member/upload_photo_by_member_id';
        ...
        success: function(data) {
            ...
            if (data.status == 'success') {
                if (croped_base64 != '') {
                    ...
                    $("div.form-group .photo" + photo_number + " .img-responsive").prop("src", croped_base64);
                }
                $(".show_btn").hide();
                $(".imageBox").hide();
                $("#upload_btn").hide();
...
function delete_photo() {
    ...
    if (photo_number == '') {
        ...
        var member_id = $("#id").val();
    var base_url = $("#base_url_admin_only").val();
    var url_load = base_url + 'member/delete_photo';
    var hash_tocken_id = $("#hash_tocken_id").val();
    ...
    $.ajax({
        ...
        type: "post",
        dataType: "json",
        data: { 'csrf_new_matrimonial': hash_tocken_id, 'is_ajax': 1, 'photo_number': photo_number, 'delete_photo': 'delete','member_id': member_id },
        success: function(data) {
