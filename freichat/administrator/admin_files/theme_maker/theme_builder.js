...
<img id='frei_img' src=" + FreiChat.make_url(freidefines.minimg) + " alt='max' height=12 width=12/> </span></div>";
    ...
    main_str += "<div class='frei_chatroom' id='frei_chatroom'>\n\
        ...
        <div style='display: block' id='frei_chatroompanel' class='frei_chatroompanel'>\n\
            <div id='frei_chatroomrightpanel' class='frei_chatroomrightpanel'>\n\
\n\
                <div id='frei_userpanel' class='frei_userpanel'><div id='frei_userlist' class='frei_userlist frei_userlistme'>\n\
                    <span class='freichat_userscontentname'>My name</span>\n\
                    </div><div id='frei_userlist' class='frei_userlist'>\n\
                                    <span class='freichat_chatroom_avatar'><img src='http://www.gravatar.com/avatar/1c188843c2b0cd62444543d61c221a4f?s=24&amp;d=wavatar' alt='avatar' align='left' class='freichat_userscontentavatarimage'></span>\n\
                                    <span class='freichat_userscontentname'>Some other username</span>\n\
                                    <span>&nbsp;<img class='freichat_userscontentstatus' src='https://localhost/humhub/freichat/client/themes/test/images/onlineimg.png' height='12' width='12' alt='status'></span>\n\
                </div></div>\n\
            </div>\n\
...
\n\
                    <div class='frei_content' tabindex='0' style='right: -15px;'>\n\
                        <div id='3_chatroom_message' class='frei_chatroom_message'><span style='display:none' id='3_message_type'>LEFT</span>\n\
                            <div class='chatroom_messagefrom_left'><span>Me</span><span class='freichat_time' style='visibility:visible;padding-right:15px'>13:17 </span></div>\n\
                            <div id='room_msg_0' class='frei_chatroom_msgcontent'><span style='color:grey'>hello</span></div>\n\
                        </div>\n\
                        <div id='3_chatroom_message' class='frei_chatroom_message'><span style='display:none' id='3_message_type'>LEFT</span>\n\
                            <div class='chatroom_messagefrom_left'><span>Guest-1uvna</span><span class='freichat_time' style='visibility:visible;padding-right:15px'>13:17 </span></div>\n\
                            <div id='room_msg_1' class='frei_chatroom_msgcontent'><span style='color:grey'><span style='color:grey'>Hello back</span></span></div>\n\
                        </div>\n\
                    </div>\n\
                </div> \n\
\n\
...
\n\
    ...
    main_str += 
        "<div class='frei_chatroom' id='frei_chatroom_lobby'>\n\
            <div id='frei_chatroomhead'>\n\
                <div id='frei_chatroom_lobby_btn' class='frei_chatroom_btn'>Rooms</div>\n\
                <div id='frei_roomtitle' class='frei_roomtitle'></div>\n\
                <div id='frei_chatroom_back_btn' class='frei_chatroom_btn'>Hide</div>\n\
            ...
            <div id='frei_lobby'>\n\
                ...
                <div id='frei_roompanel' class='frei_roompanel frei_nanocontent has-scrollbar'>\n\
                    <div class='frei_content' tabindex='0' style='right: -15px;'>\n\
                        <div id='frei_lobby_room_1' class='frei_lobby_room'>\n\
                            <span class='frei_lobby_room_1'>Fun Talk</span><span class='frei_lobby_room_2'>\n\
                            <span id='room_new_messages_1'>0</span> online</span><span class='frei_lobby_room_3'></span>\n\
                            <span class='frei_lobby_room_4'></span>\n\
                            <div style='clear:both'></div>\n\
                        </div>\n\
                        <div id='frei_lobby_room_3' class='frei_selected_room'>\n\
                            <span class='frei_lobby_room_1'>Think out loud</span><span class='frei_lobby_room_2'>\n\
                            <span id='room_new_messages_3'>1</span> online</span><span class='frei_lobby_room_3'></span>\n\
                            <span class='frei_lobby_room_4'></span>\n\
                            <div style='clear:both'></div>\n\
                        </div>\n\
                        <div id='frei_lobby_room_4' class='frei_lobby_room'>\n\
                            <span class='frei_lobby_room_1'>Talk to me </span><span class='frei_lobby_room_2'>\n\
                            <span id='room_new_messages_4'>0</span> online</span><span class='frei_lobby_room_3'></span>\n\
                            <span class='frei_lobby_room_4'></span>\n\
                            <div style='clear:both'></div>\n\
                        </div>\n\
                    </div>\n\
                    <div class='pane' style='display: none; opacity: 1; visibility: visible;'>\n\
                        <div class='slider' style='height: 318px;'></div>\n\
                    </div>\n\
                </div>\n\
...
\n\
   <div class="chatboxinput">  <span class="frei_chat_status" id="frei_chat_status_' + id + '"></span><textarea id="chatboxtextarea' + id + '" class="chatboxtextarea" onkeydown="$jn(this).scrollTop($jn(this)[0].scrollHeight); if (event.keyCode == 13 && event.shiftKey == 0) {javascript:return;}"></textarea>                </div>       </div>    </div>';
    ...
    $('#get_parent').click(function() {
        ...
        if (id == '') {
            el = $('#' + element_zoomed + ' .' + selected_element.classList[0]).parent(); //primary class / first class
        } else
            el = $('#' + id).parent();
