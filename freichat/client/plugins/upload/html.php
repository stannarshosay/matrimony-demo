    ...
    <body>
        <div class="frei_upload_border">
            <form id="send_form" name="upload" action="upload.php" method="post" enctype="multipart/form-data">
				...
				<input id="GMT_time" type="hidden" name="GMT_time" />
            </form>
        </div>
    </body>
</html>
<script>
    ...
    freiVal("roomid", opener.FreiChat.upload_room_id);
    freiVal("messagetype", opener.FreiChat.upload_message_type);
    freiVal("GMT_time", opener.FreiChat.getGMT_time());
