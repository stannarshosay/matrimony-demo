...
<html>
    ...
    <body>
        ...
        <div id="chat" data-role="page">
            ...
            <div id="option_bar" class="option_bar">
                ...
                <span id="send_video_mesg_widget" class="option_bar_widgets send_video_mesg_widget"></span>
            ...
            <script type="text/javascript">
                ...
                $jn('document').ready(function($) {
                    ...
                    if (FreiChat.plugins.is_allowed('CHATROOM')) {
                        ...
                        $jn('.frei_bottom_menu_no_chatroom').hide();
                        $jn('.frei_bottom_menu').show();
                    }else{

                        $jn('.frei_bottom_menu_no_chatroom').show();
                        $jn('.frei_bottom_menu').hide();                        
                    }                 
                });
        ...
        <div data-overlay-theme="b" data-theme="a" data-role="dialog" id="attachment_widget_popup">
            ...
            <div data-role="content" data-theme="d">
                <form id="jqm_u_form" data-ajax="false" name="upload" action="" method="post" enctype="multipart/form-data">
                    ...
                    <input id="jqm_u_GMT_time" type="hidden" name="GMT_time"/>
    ...
    <script>
		...
		$jn(document).ready(function($) {
			...
			if(typeof window.location.search.split("&")[3] !== "undefined") {


				FreiChat.open_panel(opener.FreiChat.talkTo.user, opener.FreiChat.talkTo.id);
			}
		});
