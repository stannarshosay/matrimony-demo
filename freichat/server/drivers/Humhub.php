...
class Humhub extends driver_base {
...
//------------------------------------------------------------------------------
    ...
    public function avatar_url($res) {
        ...
        $murl = str_replace("client/main.php", "", $murl);
        $basepath = dirname(dirname(dirname(__DIR__)));

        if (is_file($basepath . '/uploads/profile_image/' . $res['avatar'] . '.jpg')) {

            return $murl . 'uploads/profile_image/' . $res['avatar'] . '.jpg';
        }
        
        return $murl . 'img/default_user.jpg';
    }
...
//------------------------------------------------------------------------------
    public function get_guests() {
        ...
        $query = "SELECT DISTINCT f.status_mesg,f.username,f.session_id,f.status,f.guest,f.in_room,u.guid AS avatar
                   FROM frei_session AS f
                   LEFT JOIN user AS u ON f.session_id=u.id
